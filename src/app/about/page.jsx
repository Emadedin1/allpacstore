  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <section>
        ...
        <p className="text-lg text-gray-700">
          We aim to replace single-use plastic with eco-friendly paper packaging, while empowering businesses with
          just-in-time delivery and reliable Canadian manufacturing.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-lg text-gray-700 space-y-1">
          ...
          <li>Dome lids for our paper cups</li>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-lg text-gray-700">Fill out the contact form.</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-semibold">2. Get a Response</h3>
            <p className="text-lg text-gray-700">Our team will contact you shortly to confirm details and provide pricing.</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-semibold">3. Production &amp; Delivery</h3>
            <p className="text-lg text-gray-700">Once approved, we manufacture and deliver your packaging on time.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="text-lg text-gray-700">
          Allpac paper packaging is crafted from FSC-certified materials and designed with sustainability in mind. We continuously
          optimize production to reduce waste and energy usage while maintaining quality.
        </p>
      </section>

      {/* Community & Support (cup-focused, no custom branding) */}
      <section>
        <h2 className="text-2xl font-semibold mb-2">Community &amp; Support</h2>
        <p className="text-lg text-gray-700">
          We support partners across North America and beyond with high-volume paper cups (single-wall, double-wall) and dome lids—
          produced in Canada and delivered worldwide with consistent lead times.
        </p>
      </section>
    </div>
  );
