        ...
        <div className="mt-6 flex flex-col gap-5">
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm ring-1 ring-black/5">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1 mt-3">
              <li>FSC® Chain of Custody – responsibly managed forests.</li>
              <li>ISO 9001 Quality Management – consistent and controlled manufacturing.</li>
              <li>ISO 22000 / FSSC 22000 Food Safety Management – hygienic production for beverage-contact packaging.</li>
              <li>Food-Contact Compliance – FDA (USA) and CFIA/Health Canada standards.</li>
              <li>SMETA / BSCI Ethical Traceability – fair labour and safe factory conditions.</li>
            </ul>
            <p className="text-gray-700 mt-4 leading-relaxed">
              If you require a specific certificate or audit report, we are happy to provide supporting documentation.
            </p>
          </div>
